      ...
      <section class="person-hero" aria-labelledby="person-name">
        <div class="person-shell">
          <div class="person-avatar">
            <img v-if="person.profile_url" :src="person.profile_url" :alt="person.name" loading="eager" />
        ...
        <div class="section-body">
          <template v-if="person.all_credits.length">
            <div class="credits-list" role="list">
              <div v-for="credit in visibleCredits" :key="`${credit.media_type}-${credit.id}-${credit.role}`" class="credit-row" role="listitem">
