...
def parse_size_to_gb(size_str: str):
...
def score_item(query: str, item: dict):
    name = item.get("name", "")
    ...
    return {"score": score, "Conf": conf, "Qual": qual, "alpha": a, "tags": sorted(tags), "size_gb": size_gb}
