"""
Quark Search & Transfer API 路由

RESTful 规范：
- 搜索：GET /quark/searches?tmdb_id=xxx 或 GET /quark/searches?title=xxx
- 转存：POST /quark/transfers
"""
import logging
import re
...
@router.get(
    "/searches/tmdb/{tmdb_id}",
    summary="通过 TMDB ID 搜索夸克资源",
