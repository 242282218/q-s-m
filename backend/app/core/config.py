...
class Settings(BaseSettings):
    ...
    # Quark Transfer & WebDAV
    quark_cookie: str = Field("", alias="QUARK_TRANSFER_COOKIE")
    # Default to localhost if not set, but make it configurable
    quark_webdav_url: str = Field("http://localhost:7799/webdav", alias="QUARK_TRANSFER_WEBDAV_URL")
    quark_webdav_username: str = Field("", alias="QUARK_TRANSFER_WEBDAV_USERNAME")
    quark_webdav_password: str = Field("", alias="QUARK_TRANSFER_WEBDAV_PASSWORD")
